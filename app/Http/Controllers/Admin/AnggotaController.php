...
class AnggotaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $anggota = Anggota::create([
            ...
            'alamat_domisili' => $request->alamat_domisili ?? $request->alamat_lengkap,
        ...
        if ($request->jenis_anggota != 'Remaja Mesjid') {
            ...
            $tingkatDefault = 'Pengurus Daerah (PD)';
    ...
    {
        $request->validate([
            'file_csv' => 'required|mimes:csv,txt,xls,xlsx|max:10240',
        ]);
